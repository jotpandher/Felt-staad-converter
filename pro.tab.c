...
{
  "$end", "error", "$undefined", "xnodes", "ynodes", "znodes", "beamx",
  "beamy", "$accept", "FELT", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 25 "pro.y" /* yacc.c:1646  */
    { cout << (yyvsp[0].f) << endl; }
#line 1221 "pro.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 26 "pro.y" /* yacc.c:1646  */
    { cout << (yyvsp[0].f) << endl; }
#line 1227 "pro.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 27 "pro.y" /* yacc.c:1646  */
    { cout << (yyvsp[0].f) << endl;}
